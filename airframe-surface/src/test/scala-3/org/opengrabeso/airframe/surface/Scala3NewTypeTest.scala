...
object Scala3NewTypeTest extends AnyFunSuite with should.Matchers:
  ...
  test("support intersection type") {
    ...
    s.fullName shouldBe "java.lang.String&org.opengrabeso.airframe.surface.Scala3NewTypeTest.Label1"
  ...
  test("opaque types") {
    ...
    s.fullName shouldBe "org.opengrabeso.airframe.surface.Scala3NewTypeTest.MyEnv"
    s should not be Surface.of[String]
