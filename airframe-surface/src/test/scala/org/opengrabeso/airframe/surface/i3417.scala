...
/**
 * note: the error this is testing is non-deterministic, does not always happen
 * see https://github.com/scala/scala3/issues/19795
 * */
class i3417 extends AnyFunSuite with should.Matchers {
