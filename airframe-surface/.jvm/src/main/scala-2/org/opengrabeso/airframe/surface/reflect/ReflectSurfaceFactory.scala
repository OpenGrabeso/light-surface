...
import org.opengrabeso.airframe.surface.TypeName.sanitizeTypeName

import java.lang.reflect.{Constructor, InvocationTargetException}
import java.util.concurrent.ConcurrentHashMap
import org.opengrabeso.airframe.surface.*
...
//  }
  ...
  private class SurfaceFinder extends LogSupport {
    ...
    private def taggedTypeFactory: SurfaceMatcher = {
      case t if t.typeArgs.length == 2 && typeNameOf(t).startsWith("org.opengrabeso.airframe.surface.tag.") =>
